...
/**
 * Tellonym Configuration
 *
 * - ejected 17th April 2022.
 * - added DefinePlugin
 * - added SentryCliPlugin
 * - disabled ModuleScopePlugin
 * - customised eslint-config-react-app/base
 * - customised bable-loader
 *   - added core module to babel
 *   - added module-resolver
 */
const fs = require('fs')
...
module.exports = function (webpackEnv) {
  ...
  return {
                ...
                plugins: [
                  ...
                  [
                    'module-resolver',
                    {
                      ...
                      alias: {
                        '@tellonym/core': path.resolve(
                          __dirname,
                          '../../core/src'
                        ),
                        '@tellonym/strings': path.resolve(
                          __dirname,
                          '../../strings'
                        ),
                      },
    ...
    plugins: [
      ...
      isEnvProduction &&
        sentryWebpackPlugin({
          org: 'callosum-software',
          project: 'tellonym-web',
          authToken: process.env.SENTRY_AUTH_TOKEN,
          release: {
            name: appPackageJson.version,
          },
        }),
    ].filter(Boolean),
